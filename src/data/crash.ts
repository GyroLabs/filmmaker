...
export class CrashReport {
  ...
  private readonly logFile?: ModuleScript = undefined
  ...
  /**
	 ...
	 */
  public static openCause (cause: unknown): CrashReport {
  ...
  private put () {
    ...
    this.dataSet.set('Heartbeat\t\t', `${tostring(round2(Stats.HeartbeatTimeMs, 2))} ms`)
  ...
  public toString (): string {
    ...
    str += '\n\n'
    str += 'Filmmaker has crashed!\nIf you want to report this, please submit a Github issue @ GyroLabs/Filmmaker'
    str += '\n\n'
